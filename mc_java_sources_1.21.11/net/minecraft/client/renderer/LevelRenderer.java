...
public class LevelRenderer implements ResourceManagerReloadListener, AutoCloseable {
    ...
    public void renderLevel(
        ...
        net.minecraftforge.client.FramePassManager.insertForgePasses(framegraphbuilder, targets, this.levelRenderState, p_342180_); // Forge: Modded passes are inserted here.
