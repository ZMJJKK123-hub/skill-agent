...
public class Gui {
    ...
    public void renderChat(GuiGraphics p_329202_, DeltaTracker p_342328_) {
        if (!this.chat.isChatFocused()) {
            ...
            net.minecraftforge.client.ForgeHooksClient.onCustomizeChatEvent(p_329202_, this.chat, window, i, j, this.tickCount, this.getFont());
        }
    }
    ...
    public final void updateContextualInfo(final GuiGraphics graphics, DeltaTracker deltaTracker) {
        ...
        this.contextualInfoBar.getValue().renderBackground(graphics, deltaTracker);
    }
    // Forge: Same as above but for FLD#CONTEXTUAL_INFO
    public final void extractContextualInfoState(final GuiGraphics graphics, DeltaTracker deltaTracker) {
        this.contextualInfoBar.getValue().render(graphics, deltaTracker);
    }
    ...
    public void renderSelectedItemName(GuiGraphics p_283501_, int yShift) {
        ...
        if (this.toolHighlightTimer > 0 && !this.lastToolHighlight.isEmpty()) {
            ...
            if (l > 0) {
                p_283501_.drawStringWithBackdrop(font, highlightTip, j, k, i, ARGB.white(l));
            }
        }
    ...
    public void renderTextureOverlay(GuiGraphics p_282304_, Identifier p_457421_, float p_281504_) {
