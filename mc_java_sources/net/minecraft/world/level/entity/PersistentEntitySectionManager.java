...
public class PersistentEntitySectionManager<T extends EntityAccess> implements AutoCloseable {
   ...
   private boolean addEntity(T entity, boolean loaded) {
      return entity instanceof Entity && ForgeEventFactory.onEntityJoinLevel((Entity)entity, ((Entity)entity).level(), loaded)
         ? false
         : this.addEntityWithoutEvent(entity, loaded);
   }
      ...
      public void onMove() {
         ...
         if (newSectionPos != this.currentSectionKey) {
            ...
            if (this.realEntity != null) {
               ForgeEventFactory.onEntityEnterSection(this.realEntity, oldSectionKey, newSectionPos);
            }
         }
      }
