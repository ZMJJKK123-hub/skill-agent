         ...
         for (int dy = -1; dy <= 1; dy++) {
            for (int dz = -1; dz <= 1; dz++) {
               if (dx != 0 || dz != 0) {
                  ...
                  PathType adjacentBlockPathType = blockstate.getAdjacentBlockPathType(context.level(), pos, null, blockPathType);
                  if (adjacentBlockPathType != null) {
                     return adjacentBlockPathType;
                  }

                  PathType adjacentFluidPathType = blockstate.getFluidState().getAdjacentBlockPathType(context.level(), pos, null, blockPathType);
                  if (adjacentFluidPathType != null) {
                     return adjacentFluidPathType;
                  }
