...
public class OceanMonumentPieces {
   ...
   public static class MonumentBuilding extends OceanMonumentPieces.OceanMonumentPiece {
      ...
      private List<OceanMonumentPieces.RoomDefinition> generateRoomGraph(RandomSource random) {
         ...
         while (var34.hasNext()) {
            OceanMonumentPieces.RoomDefinition definition = (OceanMonumentPieces.RoomDefinition)var34.next();
            int closeCount = 0;
            int attemptCount = 0;
   ...
   public static class OceanMonumentWingRoom extends OceanMonumentPieces.OceanMonumentPiece {
      ...
      public void postProcess(
         ...
         if (this.mainDesign == 0) {
            ...
            for (int i = 0; i < 2; i++) {
               this.generateBox(level, chunkBB, var16, 0, 7, var16, 2, 7, BASE_LIGHT, BASE_LIGHT, false);
               this.generateBox(level, chunkBB, var16, 0, 14, var16, 2, 14, BASE_LIGHT, BASE_LIGHT, false);
               var16 = 14;
            }
