...
public class BlockEntityTypes {
   ...
   public static final BlockEntityType<PistonMovingBlockEntity> PISTON = register(BlockEntityTypeIds.PISTON, PistonMovingBlockEntity::new, Blocks.MOVING_PISTON);
