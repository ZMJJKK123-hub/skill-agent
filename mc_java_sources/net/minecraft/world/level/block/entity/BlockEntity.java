...
public abstract class BlockEntity extends CapabilityProvider.BlockEntities implements DebugValueSource, TypedInstance<BlockEntityType<?>>, IForgeBlockEntity {
   ...
   protected void loadAdditional(ValueInput input) {
      if (this.getCapabilities() != null) {
         input.<CompoundTag>read("ForgeCaps", CompoundTag.CODEC).ifPresent(caps -> this.deserializeCaps(input.lookup(), caps));
      }
   }
   ...
   protected void saveAdditional(ValueOutput output) {
      if (this.getCapabilities() != null) {
         output.storeNullable("ForgeCaps", CompoundTag.CODEC, this.serializeCaps(output));
      }
   }
