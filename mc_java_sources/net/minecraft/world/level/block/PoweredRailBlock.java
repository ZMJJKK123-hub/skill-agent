...
public class PoweredRailBlock extends BaseRailBlock {
   ...
   protected PoweredRailBlock(BlockBehaviour.Properties properties, boolean isPoweredRail) {
   ...
   protected boolean isSameRailWithPower(Level level, BlockPos pos, boolean forward, int searchDepth, RailShape dir) {
      ...
      if (state.getBlock() instanceof PoweredRailBlock other && this.isActivatorRail() == other.isActivatorRail()) {
