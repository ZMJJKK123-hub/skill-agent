...
public class LootTable implements Validatable {
   ...
   public void getRandomItems(LootParams params, long optionalLootTableSeed, Consumer<ItemStack> output) {
      this.getRandomItems(new LootContext.Builder(params).withOptionalRandomSeed(optionalLootTableSeed).create(this.randomSequence))
         .forEach(createStackSplitter(params.getLevel(), output));
   }
   ...
   private ObjectArrayList<ItemStack> getRandomItems(LootContext context) {
      ...
      return ForgeHooks.modifyLoot(this, result, context);
   }
   ...
   public void setLootTableId(Identifier id) {
   ...
   public void addPool(LootPool pool) {
      this.checkFrozen();
      if (this.pools.stream().anyMatch(e -> e == pool)) {
