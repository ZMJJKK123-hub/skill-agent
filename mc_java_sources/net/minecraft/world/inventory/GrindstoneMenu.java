...
public class GrindstoneMenu extends AbstractContainerMenu {
   ...
   public GrindstoneMenu(int containerId, Inventory inventory, final ContainerLevelAccess access) {
      ...
      this.addSlot(new Slot(this.resultSlots, 2, 129, 34) {
         ...
         public void onTake(Player player, ItemStack carried) {
            if (!ForgeHooks.onGrindstoneTake(GrindstoneMenu.this.repairSlots, access, this::getExperienceAmount)) {
   ...
   private ItemStack computeResult(ItemStack input, ItemStack additional) {
      GrindstoneEvent.OnPlaceItem event = ForgeEventFactory.onGrindstoneChange(input, additional, this.resultSlots, -1);
      if (event == null) {
         this.xp = -1;
