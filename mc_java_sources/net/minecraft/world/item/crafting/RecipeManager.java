...
public class RecipeManager extends SimplePreparableReloadListener<RecipeMap> implements RecipeAccess {
   ...
   public RecipeManager(HolderLookup.Provider registries) {
      this(registries, ICondition.IContext.EMPTY);
   }

   public RecipeManager(HolderLookup.Provider registries, ICondition.IContext context) {
   ...
   protected RecipeMap prepare(ResourceManager manager, ProfilerFiller profiler) {
      ...
      SimpleJsonResourceReloadListener.scanDirectory(
         manager, RECIPE_LISTER, this.context.wrap(this.registries.createSerializationContext(JsonOps.INSTANCE)), Recipe.CODEC, recipes
      );
