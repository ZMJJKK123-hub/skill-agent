...
public class ServerClockManager extends SavedData implements ClockManager {
   ...
   public long getTimeMarker(Holder<WorldClock> clock, ResourceKey<ClockTimeMarker> timeMarkerId) {
      ServerClockManager.ClockInstance instance = this.getInstance(clock);
      ClockTimeMarker marker = instance.timeMarkers.get(timeMarkerId);
      return marker == null ? -1L : marker.resolveTimeToMoveTo(instance.totalTicks);
   }
