...
public class Hoglin extends Animal implements Enemy, HoglinBase {
   ...
   protected void customServerAiStep(ServerLevel level) {
      ...
      if (this.isConverting()) {
         ...
         if (this.timeInOverworld > 300 && ForgeEventFactory.canLivingConvert(this, EntityTypes.ZOGLIN, timer -> this.timeInOverworld = timer)) {
   ...
   private void finishConversion() {
      this.convertTo(EntityTypes.ZOGLIN, ConversionParams.single(this, true, false), zoglin -> {
