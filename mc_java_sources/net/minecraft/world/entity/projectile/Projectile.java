...
public abstract class Projectile extends Entity implements TraceableEntity {
   ...
   public void shoot(double xd, double yd, double zd, float pow, float uncertainty) {
      ...
      this.setYRot((float)(Mth.atan2(movement.x, movement.z) * 180.0 / (float) Math.PI));
      this.setXRot((float)(Mth.atan2(movement.y, sd) * 180.0 / (float) Math.PI));
   ...
   protected void updateRotation() {
      ...
      double sd = movement.horizontalDistance();
      this.setXRot(lerpRotation(this.xRotO, (float)(Mth.atan2(movement.y, sd) * 180.0 / (float) Math.PI)));
      this.setYRot(lerpRotation(this.yRotO, (float)(Mth.atan2(movement.x, movement.z) * 180.0 / (float) Math.PI)));
   }
   ...
   public boolean mayInteract(ServerLevel level, BlockPos pos) {
      Entity owner = this.getOwner();
      return owner instanceof Player ? owner.mayInteract(level, pos) : owner == null || ForgeEventFactory.getMobGriefingEvent(level, owner);
   }
