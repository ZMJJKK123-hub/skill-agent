...
public final class ProjectileUtil {
   ...
   public static void rotateTowardsMovement(Entity projectile, float rotationSpeed) {
      ...
      if (movement.lengthSqr() != 0.0) {
         ...
         projectile.setYRot((float)(Mth.atan2(movement.z, movement.x) * 180.0 / (float) Math.PI) + 90.0F);
         projectile.setXRot((float)(Mth.atan2(sd, movement.y) * 180.0 / (float) Math.PI) - 90.0F);
