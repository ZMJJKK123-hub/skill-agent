...
public class Brain<E extends LivingEntity> {
   ...
   public static <E extends LivingEntity> Brain.Provider<E> provider(Collection<? extends SensorType<? extends Sensor<? super E>>> sensorTypes) {
      return new Brain.Provider<>(ImmutableList.of(), sensorTypes, var0x -> List.of());
   }
   ...
   public interface ActivitySupplier<E extends LivingEntity> {
      List<ActivityData<E>> createActivities(E var1);
   }
   ...
   public interface Visitor {
      <U> void acceptEmpty(MemoryModuleType<U> var1);

      <U> void accept(MemoryModuleType<U> var1, U var2);

      <U> void accept(MemoryModuleType<U> var1, U var2, long var3);
   }
}
