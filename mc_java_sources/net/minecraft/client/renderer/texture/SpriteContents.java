...
public class SpriteContents implements AutoCloseable, Stitcher.Entry {
   ...
   private SpriteContents.@Nullable AnimatedTexture createAnimatedTexture(FrameSize frameSize, int fullWidth, int fullHeight, AnimationMetadataSection metadata) {
