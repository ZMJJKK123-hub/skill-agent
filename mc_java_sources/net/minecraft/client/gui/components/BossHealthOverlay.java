   ...
   public void extractRenderState(GuiGraphicsExtractor graphics) {
      if (!this.events.isEmpty()) {
         ...
         for (LerpingBossEvent event : this.events.values()) {
            ...
            int yo = yOffset;
            CustomizeGuiOverlayEvent.BossEventProgress progressEvent = ForgeHooksClient.onCustomizeBossEventProgress(
               graphics, this.minecraft.getWindow(), event, xLeft, yOffset, 10 + 9
            );
