...
class FriendEntry extends AbstractFriendsEntryContainerWidget {
   ...
   public FriendEntry(
      ...
      this.removeButton = SpriteIconButton.builder(UNFRIEND, var2x -> this.confirmRemoveFriend(onAction), true)
         .size(20, 20)
   ...
   private void confirmRemoveFriend(Runnable action) {
      this.minecraft
         ...
         }).addButton(CommonComponents.GUI_CANCEL, var1x -> this.minecraft.gui.setScreen(this.screen)).build());
   }
}
