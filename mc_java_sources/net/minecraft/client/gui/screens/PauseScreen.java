...
public class PauseScreen extends Screen {
   ...
   private void createPauseMenu() {
      ...
      helper.addChild(
         Button.builder(Component.translatable("fml.menu.mods"), button -> this.minecraft.gui.setScreen(new ModListScreen(this))).width(204).build(), 2
      );
   ...
   private Button openScreenButton(Component message, Supplier<Screen> newScreen) {
      return Button.builder(message, var2x -> this.minecraft.gui.setScreen(newScreen.get())).width(98).build();
   }
