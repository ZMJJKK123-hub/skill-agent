...
public final class OptionInstance<T> {
   ...
   public void set(T value) {
      ...
      if (!Minecraft.getInstance().isRunning()) {
         this.value = newValue;
      } else if (!Objects.equals(this.value, newValue)) {
         this.value = newValue;
   ...
   public interface ValueSet<T> {
      Function<OptionInstance<T>, AbstractWidget> createButton(
         OptionInstance.TooltipSupplier<T> var1, Options var2, int var3, int var4, int var5, OptionInstance.ValueUpdateListener<? super T> var6
      );
