...
public class ItemModelGenerator implements UnbakedModel {
   ...
   private static QuadCollection bake(TextureSlots textureSlots, ModelBaker modelBaker, ModelState modelState, ModelDebugName name) {
      ...
      while (true) {
         String textureReference = String.format(Locale.ROOT, "layer%d", layerIndex);
   ...
   public static void bakeExtrudedSprite(
      QuadCollection.Builder builder, ModelBaker.Interner interner, ModelState modelState, BakedQuad.MaterialInfo materialInfo, BakedQuad.MaterialInfo template
   ) {
