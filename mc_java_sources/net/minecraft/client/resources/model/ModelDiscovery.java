   ...
   public static class ModelWrapper implements ResolvedModel {
      ...
      public IGeometryBakingContext getContext() {
         if (this.context == null || this.context.parent() != this.parent) {
            this.context = new ModelContext(this);
         }
      ...
      private QuadCollection bakeDefaultState(TextureSlots textureSlots, ModelBaker baker, ModelState state) {
         ...
         return result != null
            ? result
            : this.updateSlot(KEY_DEFAULT_GEOMETRY, this.getTopGeometry().bake(textureSlots, baker, state, this, this.getContext()));
      }
      ...
      public QuadCollection bakeTopGeometry(TextureSlots textureSlots, ModelBaker baker, ModelState state) {
         return state == BlockModelRotation.IDENTITY ? this.bakeDefaultState(textureSlots, baker, state) : this.modelBakeCache.computeIfAbsent(state, s -> {
            ...
            return topGeometry.bake(textureSlots, baker, s, this, this.getContext());
         });
      }
   }
