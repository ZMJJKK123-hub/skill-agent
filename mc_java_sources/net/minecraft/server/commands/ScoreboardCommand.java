...
public class ScoreboardCommand {
   ...
   private static int performOperation(
      ...
      if (targets.size() == 1) {
         ...
         source.sendSuccess(
            () -> Component.translatable("commands.scoreboard.players.operation.success.multiple", targetObjective.getFormattedDisplayName(), targets.size()),
            true
         );
      }
   ...
   private static int enableTrigger(CommandSourceStack source, Collection<ScoreHolder> names, Objective objective) throws CommandSyntaxException {
      ...
      if (names.size() == 1) {
         source.sendSuccess(
            () -> Component.translatable("commands.scoreboard.players.enable.success.single", objective.getFormattedDisplayName(), getFirstTargetName(names)),
            true
         );
      } else {
         source.sendSuccess(
   ...
   private static int resetScore(CommandSourceStack source, Collection<ScoreHolder> names, Objective objective) {
      ...
      if (names.size() == 1) {
         source.sendSuccess(
            () -> Component.translatable("commands.scoreboard.players.reset.specific.single", objective.getFormattedDisplayName(), getFirstTargetName(names)),
            true
         );
      } else {
         source.sendSuccess(
   ...
   private static int setScore(CommandSourceStack source, Collection<ScoreHolder> names, Objective objective, int value) {
      ...
      if (names.size() == 1) {
         ...
         source.sendSuccess(
            () -> Component.translatable("commands.scoreboard.players.set.success.multiple", objective.getFormattedDisplayName(), names.size(), value), true
         );
      }
   ...
   private static int addScore(CommandSourceStack source, Collection<ScoreHolder> names, Objective objective, int value) {
      ...
      if (names.size() == 1) {
         ...
         source.sendSuccess(
            () -> Component.translatable("commands.scoreboard.players.add.success.multiple", value, objective.getFormattedDisplayName(), names.size()), true
         );
      }
   ...
   private static int removeScore(CommandSourceStack source, Collection<ScoreHolder> names, Objective objective, int value) {
      ...
      if (names.size() == 1) {
         ...
         source.sendSuccess(
            () -> Component.translatable("commands.scoreboard.players.remove.success.multiple", value, objective.getFormattedDisplayName(), names.size()), true
         );
      }
