...
public class ReloadableServerResources {
   ...
   private ReloadableServerResources(
      ...
      this.context = new ConditionContext(this.postponedTags);
      this.recipes = new RecipeManager(loadingContext, this.context);
      this.advancements = new ServerAdvancementManager(loadingContext, this.context);
               ...
               .thenCompose(
                  pendingComponents -> {
                     ...
                     return SimpleReloadInstance.create(
                           resourceManager,
                           ForgeEventFactory.onResourceReload(result, fullRegistries.lookupWithUpdatedTags(), result.listeners()),
                           backgroundExecutor,
                           mainThreadExecutor,
