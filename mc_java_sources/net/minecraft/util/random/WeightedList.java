...
import net.minecraftforge.common.extensions.IForgeWeightedList;
import org.jspecify.annotations.Nullable;

public final class WeightedList<E> implements IForgeWeightedList<E> {
   ...
   public boolean equals(@Nullable Object obj) {
      if (this == obj) {
         ...
         return obj instanceof WeightedList<?> list ? this.totalWeight == list.totalWeight && Objects.equals(this.items, list.items) : false;
      }
   }
   ...
   public static class Builder<E> implements IForgeWeightedList.Builder<E> {
