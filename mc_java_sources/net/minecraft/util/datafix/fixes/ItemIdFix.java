...
public class ItemIdFix extends DataFix {
   private static final Int2ObjectMap<String> ITEM_NAMES = (Int2ObjectMap<String>)DataFixUtils.make(new Int2ObjectOpenHashMap(), map -> {
   ...
   public TypeRewriteRule makeRule() {
      ...
      return this.fixTypeEverywhereTyped(
         ...
         itemStack -> itemStack.update(id, newItemType, oldId -> (Pair)oldId.map(l -> Pair.of(References.ITEM_NAME.typeName(), getItem(l)), r -> r))
      );
   }
}
