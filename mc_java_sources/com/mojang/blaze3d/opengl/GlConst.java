...
public class GlConst {
   ...
   public static int toGlInternalId(GpuFormat gpuFormat, boolean stencil) {
      if (stencil && gpuFormat.hasDepthAspect()) {
         return 36013;
      }
   ...
   public static int toGlExternalId(GpuFormat gpuFormat, boolean stencil) {
      if (stencil && gpuFormat.hasDepthAspect()) {
         return 34041;
      }
   ...
   public static int toGlType(GpuFormat gpuFormat, boolean stencil) {
      if (stencil && gpuFormat.hasDepthAspect()) {
         return 36269;
      }
