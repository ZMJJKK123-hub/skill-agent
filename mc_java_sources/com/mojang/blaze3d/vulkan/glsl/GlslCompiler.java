...
public class GlslCompiler implements AutoCloseable {
   ...
   public GlslCompiler.CompiledModules compile(VulkanDevice device, RenderPipeline pipeline, IntermediaryShaderModule vertex, IntermediaryShaderModule fragment) throws ShaderCompileException {
