...
public interface VulkanDebug {
   ...
   void chainCreateInfo(VkInstanceCreateInfo var1, MemoryStack var2);

   void setup(VkInstance var1);

   void setObjectName(VkDevice var1, int var2, long var3, String var5);

   void setObjectName(VkDevice var1, int var2, long var3, Supplier<String> var5);

   void beginDebugGroup(VkCommandBuffer var1, Supplier<String> var2);

   void endDebugGroup(VkCommandBuffer var1);

   void destroy(VkInstance var1);
