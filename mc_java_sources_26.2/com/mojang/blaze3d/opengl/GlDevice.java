...
class GlDevice implements GpuDeviceBackend {
   ...
   public GpuTexture createTexture(
      ...
      return this.createTexture(label, usage, format, width, height, depthOrLayers, mipLevels, false);
   }
   ...
   public GpuTexture createTexture(
      ...
      return this.createTexture(
         this.debugLabels.exists() && label != null ? label.get() : null, usage, format, width, height, depthOrLayers, mipLevels, stencil
      );
   }
