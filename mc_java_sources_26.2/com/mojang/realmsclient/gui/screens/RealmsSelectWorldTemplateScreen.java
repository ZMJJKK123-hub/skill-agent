...
public class RealmsSelectWorldTemplateScreen extends RealmsScreen {
   ...
   @Override
   public void init() {
      this.layout.setHeaderHeight(33 + this.subtitle.size() * 13);
   ...
   private class Entry extends ObjectSelectionList.Entry<RealmsSelectWorldTemplateScreen.Entry> {
      ...
      public void extractContent(GuiGraphicsExtractor graphics, int mouseX, int mouseY, boolean hovered, float a) {
         ...
         if (!this.template.recommendedPlayers().isBlank()) {
            graphics.text(RealmsSelectWorldTemplateScreen.this.font, this.template.recommendedPlayers(), textX, this.getContentBottom() - 4 - 5, -8355712);
         }
      }
