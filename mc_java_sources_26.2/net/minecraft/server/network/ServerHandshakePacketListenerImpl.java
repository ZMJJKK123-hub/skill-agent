...
public class ServerHandshakePacketListenerImpl implements ServerHandshakePacketListener {
   ...
   public void handleIntention(ClientIntentionPacket packet) {
      if (ServerLifecycleHooks.handleServerLogin(packet, this.connection)) {
               ...
               if (this.server.repliesToStatus() && status != null) {
                  this.connection
                     .setupInboundProtocol(
                        StatusProtocols.SERVERBOUND, new ServerStatusPacketListenerImpl(status, this.connection, this.server.getStatusJson())
                     );
               } else {
