...
public class ServerPacksSource extends BuiltInPackSource {
   ...
   public static PackRepository createPackRepository(Path datapackDir, DirectoryValidator validator) {
      PackRepository ret = new PackRepository(
         new ServerPacksSource(validator), new FolderRepositorySource(datapackDir, PackType.SERVER_DATA, PackSource.WORLD, validator)
      );
      AddPackFindersEvent.BUS.post(new AddPackFindersEvent(PackType.SERVER_DATA, ret::addPackFinder));
      return ret;
   }
