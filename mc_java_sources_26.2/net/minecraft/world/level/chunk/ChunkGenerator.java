...
public abstract class ChunkGenerator {
   ...
   private final ClearableLazy<List<FeatureSorter.StepFeatureData>> featuresPerStep;
   ...
   public ChunkGenerator(BiomeSource biomeSource, Function<Holder<Biome>, BiomeGenerationSettings> generationSettingsGetter) {
      ...
      this.featuresPerStep = ClearableLazy.concurrentOf(
   ...
   public void refreshFeaturesPerStep() {
      this.featuresPerStep.invalidate();
   }
