...
public final class StructureStart {
   ...
   public CompoundTag createTag(StructurePieceSerializationContext context, ChunkPos chunkPos) {
      ...
      if (this.isValid()) {
         if (context.registryAccess().lookupOrThrow(Registries.STRUCTURE).getKey(this.getStructure()) == null) {
            throw new RuntimeException(
               "StructureStart \"" + this.getClass().getName() + "\": \"" + this.getStructure() + "\" unregistered, serializing impossible."
            );
         }
