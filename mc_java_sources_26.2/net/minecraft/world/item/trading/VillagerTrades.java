...
public class VillagerTrades {
   ...
   public static Holder<VillagerTrade> bootstrap(BootstrapContext<VillagerTrade> context) {
      ...
      register(
         ...
         new VillagerTrade(
            new TradeCost(Items.EMERALD, 5), new ItemStackTemplate(Items.LEATHER_HELMET), 12, 5, 0.2F, Optional.empty(), dyedItem(items, Items.LEATHER_HELMET)
         )
      );
      register(
         context,
         ...
         new VillagerTrade(
            new TradeCost(Items.EMERALD, 4), new ItemStackTemplate(Items.LEATHER_BOOTS), 12, 5, 0.2F, Optional.empty(), dyedItem(items, Items.LEATHER_BOOTS)
         )
      );
      register(
         context,
   ...
   private static void registerBoatTrades(BootstrapContext<VillagerTrade> context, HolderGetter<VillagerType> villagerVariants) {
      ...
      register(
         context, FISHERMAN_5_SPRUCE_BOAT_EMERALD, createMasonBoatBuyTrade(villagerVariants, Items.SPRUCE_BOAT, List.of(VillagerType.TAIGA, VillagerType.SNOW))
      );
      register(
         context,
   ...
   private static void registerCartographerBannerTrades(BootstrapContext<VillagerTrade> context, HolderGetter<VillagerType> villagerVariants) {
      ...
      register(
         context, CARTOGRAPHER_4_EMERALD_MAGENTA_BANNER, createCartographerBannerSell(villagerVariants, Items.BANNER.magenta(), List.of(VillagerType.SAVANNA))
      );
      register(
         context,
               ...
               new ItemPredicate.Builder()
                  ...
                  .withComponents(
                     DataComponentMatchers.Builder.components()
                        .partial(
                           DataComponentPredicates.STORED_ENCHANTMENTS,
                           EnchantmentsPredicate.storedEnchantments(List.of(new EnchantmentPredicate(Optional.empty(), MinMaxBounds.Ints.exactly(level))))
                        )
                        .build()
                  )
                  .build()
