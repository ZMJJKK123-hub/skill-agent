...
public class RemoveBlockGoal extends MoveToBlockGoal {
   ...
   public boolean canUse() {
      if (!ForgeEventFactory.getMobGriefingEvent(getServerLevel(this.removerMob.level()), this.removerMob)) {
         return false;
   ...
   protected boolean isValidTarget(LevelReader level, BlockPos pos) {
      ...
      return chunk == null
         ? false
         : chunk.getBlockState(pos).canEntityDestroy(level, pos, this.removerMob)
