...
public abstract class PathNavigation {
   ...
   protected void followThePath() {
      ...
      double xDistance = Math.abs(this.mob.getX() - (currentNodePos.getX() + (this.mob.getBbWidth() + 1.0F) / 2.0));
      double yDistance = Math.abs(this.mob.getY() - currentNodePos.getY());
      double zDistance = Math.abs(this.mob.getZ() - (currentNodePos.getZ() + (this.mob.getBbWidth() + 1.0F) / 2.0));
