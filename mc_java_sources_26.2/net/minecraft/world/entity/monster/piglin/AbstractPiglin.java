...
public abstract class AbstractPiglin extends Monster {
   ...
   protected void customServerAiStep(ServerLevel level) {
      ...
      if (this.timeInOverworld > 300 && ForgeEventFactory.canLivingConvert(this, EntityTypes.ZOMBIFIED_PIGLIN, timer -> this.timeInOverworld = timer)) {
   ...
   protected void finishConversion(ServerLevel level) {
      this.convertTo(EntityTypes.ZOMBIFIED_PIGLIN, ConversionParams.single(this, true, true), zombified -> {
