...
public class BrewingStandMenu extends AbstractContainerMenu {
   ...
   public ItemStack quickMoveStack(Player player, int slotIndex) {
      ...
      if (slot != null && slot.hasItem()) {
         ...
         if ((slotIndex < 0 || slotIndex > 2) && slotIndex != 3 && slotIndex != 4) {
            ...
            } else if (this.slots.get(0).mayPlace(clicked)) {
   ...
   public static class PotionSlot extends Slot {
      ...
      @Override
      public boolean mayPlace(ItemStack itemStack) {
         return this.potionBrewing != null ? this.potionBrewing.isValidInput(itemStack) : mayPlaceItem(itemStack);
      }
      ...
      public void onTake(Player player, ItemStack carried) {
         ...
         if (potion.isPresent() && player instanceof ServerPlayer serverPlayer) {
            ForgeEventFactory.onPlayerBrewedPotion(player, carried);
