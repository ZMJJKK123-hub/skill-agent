   ...
   public static class Starter extends NoRenderParticle {
      ...
      public void tick() {
         ...
         if (this.life % 2 == 0 && this.life / 2 < this.explosions.size()) {
            ...
            FireworkShapeFactoryRegistry.Factory factory = FireworkShapeFactoryRegistry.get(explosion.shape());
            if (factory != null) {
               factory.build(this, trail, twinkle, colors.toIntArray(), colors.toIntArray());
            } else {
