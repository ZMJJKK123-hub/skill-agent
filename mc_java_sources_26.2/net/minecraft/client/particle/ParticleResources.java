...
public class ParticleResources implements PreparableReloadListener {
   ...
   private final Map<Identifier, ParticleProvider<?>> providersByName = new HashMap<>();
   ...
   public <T extends ParticleOptions> void register(ParticleType<T> type, ParticleProvider<T> provider) {
      ...
      this.providersByName.put(BuiltInRegistries.PARTICLE_TYPE.getKey(type), provider);
   }
   ...
   public <T extends ParticleOptions> void register(ParticleType<T> type, ParticleResources.SpriteParticleRegistration<T> provider) {
      ...
      this.register(type, provider.create(spriteSet));
   }
