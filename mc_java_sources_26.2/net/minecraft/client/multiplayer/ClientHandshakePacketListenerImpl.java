...
public class ClientHandshakePacketListenerImpl implements ClientLoginPacketListener {
         ...
         .setupInboundProtocol(
            ...
            new ClientConfigurationPacketListenerImpl(
               ...
               new CommonListenerCookie(
                  ...
                  localGameProfile,
                  this.minecraft.getTelemetryManager().createWorldSessionManager(this.newWorld, this.worldLoadDuration, this.minigameName, packet.sessionId()),
   ...
   public void onDisconnect(DisconnectionDetails details) {
      ...
      } else if (!ForgeHooksClient.onClientDisconnect(this.connection, this.minecraft, this.parent, details.reason())) {
   ...
   public void handleCustomQuery(ClientboundCustomQueryPacket packet) {
      if (!ForgeHooks.onCustomPayload(packet, this.connection)) {
