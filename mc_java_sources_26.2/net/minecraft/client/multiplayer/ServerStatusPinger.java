...
public class ServerStatusPinger {
         ...
         ClientStatusPacketListener listener = new ClientStatusPacketListener() {
            ...
            public void handleStatusResponse(ClientboundStatusResponsePacket packet) {
               if (this.receivedPing) {
                  ...
                  ForgeHooksClient.processForgeListPingData(status, data);
   ...
   private void pingLegacyServer(
      InetSocketAddress resolvedAddress, final ServerAddress rawAddress, final ServerData data, EventLoopGroupHolder eventLoopGroupHolder
   ) {
      ((Bootstrap)((Bootstrap)((Bootstrap)new Bootstrap().group(eventLoopGroupHolder.eventLoopGroup(true))).handler(new ChannelInitializer<Channel>() {
