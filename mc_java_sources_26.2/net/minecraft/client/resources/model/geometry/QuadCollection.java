...
public class QuadCollection {
   ...
   public QuadCollection transform(IQuadTransformer transformer) {
      return new QuadCollection(
         transformer.process(this.all),
         transformer.process(this.unculled),
         transformer.process(this.north),
         transformer.process(this.south),
         transformer.process(this.east),
         transformer.process(this.west),
         transformer.process(this.up),
         transformer.process(this.down)
      );
   }
