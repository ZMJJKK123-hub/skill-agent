...
public abstract class LivingEntityRenderer<T extends LivingEntity, S extends LivingEntityRenderState, M extends EntityModel<? super S>>
   ...
   public void submit(S state, PoseStack poseStack, SubmitNodeCollector submitNodeCollector, CameraRenderState camera) {
      if (!ForgeEventFactoryClient.onRenderLivingPre(state, this, poseStack, submitNodeCollector, camera)) {
         poseStack.pushPose();
         ...
         ForgeEventFactoryClient.onRenderLivingPost(state, this, poseStack, submitNodeCollector, camera);
      }
   }
   ...
   public void extractRenderState(T entity, S state, float partialTicks) {
      ...
      state.isInWater = entity.isInWaterOrSwimmable();
