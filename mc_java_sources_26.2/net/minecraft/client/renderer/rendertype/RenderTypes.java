...
public class RenderTypes {
   ...
   private static final Function<Identifier, RenderType> TEXT_GRAYSCALE_POLYGON_OFFSET = Util.memoize(
      texture -> RenderType.create(
         ...
         RenderSetup.builder(RenderPipelines.TEXT_GRAYSCALE_POLYGON_OFFSET).withTexture("Sampler0", texture).useLightmap().sortOnUpload().createRenderSetup()
      )
   );
   ...
   public static RenderType text(Identifier texture) {
      return ForgeRenderTypes.getText(texture);
   }
   ...
   public static RenderType textGrayscale(Identifier texture) {
      return ForgeRenderTypes.getTextGrayscale(texture);
   }

   public static RenderType textPolygonOffset(Identifier texture) {
      return ForgeRenderTypes.getTextPolygonOffset(texture);
   }

   public static RenderType textGrayscalePolygonOffset(Identifier texture) {
      return ForgeRenderTypes.getTextGrayscalePolygonOffset(texture);
   }

   public static RenderType textSeeThrough(Identifier texture) {
      return ForgeRenderTypes.getTextSeeThrough(texture);
   }
   ...
   public static RenderType textGrayscaleSeeThrough(Identifier texture) {
      return ForgeRenderTypes.getTextGrayscaleSeeThrough(texture);
   }
