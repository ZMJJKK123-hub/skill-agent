...
public abstract class Screen extends AbstractContainerEventHandler implements Renderable {
   ...
   public final void init(int width, int height) {
      ...
      this.height = height;
      if (!this.initialized) {
         if (!ScreenEvent.Init.Pre.BUS.post(new ScreenEvent.Init.Pre(this, this.children, this::addEventWidget, this::removeWidget))) {
            this.init();
         }

         this.setInitialFocus();
         ScreenEvent.Init.Post.BUS.post(new ScreenEvent.Init.Post(this, this.children, this::addEventWidget, this::removeWidget));
      } else {
   ...
   public void extractBackground(GuiGraphicsExtractor graphics, int mouseX, int mouseY, float a) {
      ...
      ForgeEventFactoryClient.onRenderScreenBackground(this, graphics);
