...
public abstract class AbstractContainerScreen<T extends AbstractContainerMenu> extends Screen implements MenuAccess<T> {
   ...
   protected void extractTooltip(GuiGraphicsExtractor graphics, int mouseX, int mouseY) {
      if (this.hoveredSlot != null && this.hoveredSlot.hasItem()) {
         ...
         if (this.menu.getCarried().isEmpty() || this.showTooltipWithItemInHand(item)) {
            graphics.setTooltipForNextFrame(this.font, this.getTooltipFromContainerItem(item), item.getTooltipImage(), item, mouseX, mouseY);
         }
      }
   }
   ...
   private void extractFloatingItem(GuiGraphicsExtractor graphics, ItemStack carried, int x, int y, @Nullable String itemCount) {
      ...
      Font font = IClientItemExtensions.of(carried).getFont(carried, IClientItemExtensions.FontContext.ITEM_COUNT);
      graphics.itemDecorations(font == null ? this.font : font, carried, x, y, itemCount);
   }
