...
class AddFriendWidget extends AbstractContainerWidget {
   ...
   AddFriendWidget(int width, Runnable afterSend) {
      ...
      this.addButton = SpriteIconButton.builder(SEND_REQUEST, var2x -> {
         ...
         if (name.isBlank()) {
            ...
            if (invalidInputReason != null) {
               ...
               this.minecraft.getPlayerSocialManager().sendFriendRequest(name).thenAcceptAsync(var2xx -> {
      ...
      this.profileNameButton = new PlainTextButton(
         0, 0, profileNameWidth, 9, profileNameComponent, var2x -> this.minecraft.keyboardHandler.setClipboard(profileName), this.minecraft.font
      ) {
         @Override
