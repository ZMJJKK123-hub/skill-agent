...
public class CreateWorldScreen extends Screen {
   ...
   private static void openCreateWorldScreen(
      ...
      ForgeEventFactory.addPackFindersServer(vanillaOnlyPackRepository::addPackFinder);
                        ...
                        new ConfirmScreen(
                           retry -> {
                              if (retry) {
                                 ...
                                 onAbort.accept(
                                    new WorldDataConfiguration(new DataPackConfig(ImmutableList.of("vanilla"), ImmutableList.of()), FeatureFlags.DEFAULT_FLAGS)
                                 );
                              }
                           },
   ...
   private @Nullable Pair<Path, PackRepository> getDataPackSelectionSettings(WorldDataConfiguration dataConfiguration) {
      ...
      if (dataPackDir != null) {
         if (this.tempDataPackRepository == null) {
            ...
            ResourcePackLoader.loadResourcePacks(this.tempDataPackRepository, false);
