...
public class MouseHandler {
   ...
   private void onButton(long handle, MouseButtonInfo rawButtonInfo, @MouseButtonInfo.Action int action) {
      ...
      if (handle == window.handle()) {
         ...
         if (ForgeEventFactoryClient.onMouseButtonPre(buttonInfo, action)) {
            return;
         }
            ...
            if (this.minecraft.gui.screen() == null) {
               ...
               if (pressed) {
                  ...
                  try {
                     ...
                     if (ForgeEventFactoryClient.onScreenMouseClicked(screen, xm, ym, event, doubleClick)) {
                  ...
                  try {
                     if (ForgeEventFactoryClient.onScreenMouseReleased(screen, xm, ym, event)) {
                        return;
                     }
                  } catch (Throwable t) {
         ...
         ForgeEventFactoryClient.onMouseButtonPost(buttonInfo, action);
      }
   }
      ...
      if (handle == this.minecraft.getWindow().handle()) {
         ...
         if (this.minecraft.gui.overlay() == null) {
            if (this.minecraft.gui.screen() != null) {
               ...
               if (ForgeEventFactoryClient.onScreenMouseScrollPre(this.minecraft.gui.screen(), xm, ym, scaledXOffset, scaledYOffset)) {
                  return;
               }
               ...
               ForgeEventFactoryClient.onScreenMouseScrollPost(this.minecraft.gui.screen(), xm, ym, scaledXOffset, scaledYOffset);
               ...
               if (ForgeEventFactoryClient.onMouseScroll(this, scaledXOffset, scaledYOffset)) {
                  return;
               }
      ...
      if (this.minecraft.isWindowActive()) {
         ...
         if (screen != null && this.minecraft.gui.overlay() == null && mouseMoved) {
            ...
            if (this.activeButton != null && this.mousePressedTime > 0.0) {
               ...
               try {
                  ForgeHooksClient.onScreenMouseDrag(screen, new MouseButtonEvent(xm, ym, this.activeButton), dx, dy);
               } catch (Throwable t) {
