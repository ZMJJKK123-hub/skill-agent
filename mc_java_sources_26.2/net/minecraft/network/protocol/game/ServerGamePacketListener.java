...
public interface ServerGamePacketListener extends ServerCommonPacketListener, ServerPingPacketListener {
   ...
   void handleAttack(ServerboundAttackPacket var1);

   void handleInteract(ServerboundInteractPacket var1);

   void handleSpectatorAction(ServerboundSpectatorActionPacket var1);
   ...
   void handleSetGameRule(ServerboundSetGameRulePacket var1);
