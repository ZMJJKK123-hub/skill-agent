...
public class DataComponentInitializers {
   ...
   public interface Initializer<T> {
      void run(DataComponentMap.Builder var1, HolderLookup.Provider var2, ResourceKey<T> var3);
   ...
   public interface PendingComponents<T> {
      ...
      void forEach(BiConsumer<Holder.Reference<T>, DataComponentMap> var1);
   ...
   public interface SingleComponentInitializer<C> {
      C create(HolderLookup.Provider var1);
