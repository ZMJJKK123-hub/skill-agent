...
public class Registries {
   ...
   private static String registryDirPath(ResourceKey<? extends Registry<?>> registryKey) {
      return !registryKey.identifier().getNamespace().equals("minecraft")
         ? registryKey.identifier().getNamespace() + "/" + registryKey.identifier().getPath()
         : registryKey.identifier().getPath();
   }
