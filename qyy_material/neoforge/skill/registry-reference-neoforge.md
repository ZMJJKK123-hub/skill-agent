...
|---------------------|-------------------|------|
| `Registries.BLOCK` | `Registries.BLOCK` | 方块 |
| `Registries.ITEM` | `Registries.ITEM` | 物品 |
| `Registries.BLOCK_ENTITY_TYPE` | `Registries.BLOCK_ENTITY_TYPE` | 方块实体类型 |
| `Registries.ENTITY_TYPE` | `Registries.ENTITY_TYPE` | 实体类型 |
| `Registries.CREATIVE_MODE_TAB` | `Registries.CREATIVE_MODE_TAB` | 创造标签页 |
| `Registries.MENU` | `Registries.MENU` | 容器菜单类型 |
| `Registries.SOUND_EVENT` | `Registries.SOUND_EVENT` | 声音事件 |
| `Registries.PARTICLE_TYPE` | `Registries.PARTICLE_TYPE` | 粒子类型 |
| `Registries.MOB_EFFECT` | `Registries.MOB_EFFECT` | 状态效果 |
| `ForgeRegistries.POTIONS` | `Registries.POTION` | 药水 |
| `Registries.ENCHANTMENT` | `Registries.ENCHANTMENT` | 附魔 |
...
public class ModSounds {
    public static final DeferredRegister<SoundEvent> SOUNDS =
        DeferredRegister.create(Registries.SOUND_EVENT, MyMod.MODID);
...
public class MyMod {
    ...
    public MyMod() {
        var modEventBus = modEventBus (constructor injection);
...
4. ❌ 使用 `Registries.BLOCK` → ✅ Forge使用 `Registries.BLOCK`