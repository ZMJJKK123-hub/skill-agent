...
skill_loader = SkillLoader()  # 模块单例（handlers/load_skill 与目录注入共用）


# 技能目录 digest 注入拆至 skills_catalog（loop 注入器与 handlers 引用）
from .skills_catalog import maybe_inject_skill_catalog  # noqa: E402,F401
