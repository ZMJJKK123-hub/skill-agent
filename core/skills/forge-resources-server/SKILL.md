...
description: 'Forge server-side data: data pack structure, recipes (custom/ingredients/in-code), loot tables, tags, global loot modifiers, advancements, conditional data and tags list.'
---
